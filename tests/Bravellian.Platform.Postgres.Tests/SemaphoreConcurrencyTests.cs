...
public class SemaphoreConcurrencyTests : PostgresTestBase
{
    private ISemaphoreService? semaphoreService;

    public SemaphoreConcurrencyTests(ITestOutputHelper testOutputHelper, PostgresCollectionFixture fixture)
