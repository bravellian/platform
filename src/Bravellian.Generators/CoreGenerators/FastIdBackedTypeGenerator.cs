...
public static class FastIdBackedTypeGenerator
{
    ...
    private static string GenerateClass(GeneratorParams relatedClass)
    {
        ...
        var bravellianInterfaces = GeneratorConfig.IncludeBravellianInterfaces
            ? new[] { "Bravellian.IHasValueConverter", $"Bravellian.IBgParsable<{relatedClass.Name}>", $"Bravellian.IFastIdBackedType<{relatedClass.Name}>" }
            : Array.Empty<string>();
...
""";
    ...
    public readonly record struct GeneratorParams
    {
        ...
        public GeneratorParams(string name, string ns, bool isPublic, string sourceFilePath)
        {
            this.Name = name;
            this.Namespace = ns;
