...
public static class StringBackedTypeGenerator
{
    ...
    private static string GenerateClass(in GeneratorParams relatedClass)
    {
        ...
        var bravellianInterfaces = GeneratorConfig.IncludeBravellianInterfaces
            ? new[] { "Bravellian.IHasValueConverter", $"Bravellian.IBgParsable<{relatedClass.Name}>", $"Bravellian.IStringBackedType<{relatedClass.Name}>" }
            : Array.Empty<string>();

        var allInterfaces = standardInterfaces.Concat(bravellianInterfaces);
...
public readonly {{partialKeyword}}record struct {{relatedClass.Name}}
        : {{interfaceList}}
{
...
""";
    ...
    private static string GenerateClassWithRegexConst(in GeneratorParams relatedClass)
    {
        ...
        var bravellianInterfaces = GeneratorConfig.IncludeBravellianInterfaces
            ? new[] { "Bravellian.IHasValueConverter", $"Bravellian.IStringBackedType<{relatedClass.Name}>" }
            : Array.Empty<string>();
...
""";
    ...
    public readonly record struct GeneratorParams
    {
        ...
        public GeneratorParams(string name, string ns, bool isPublic, string? regex, string? regexConstName, IReadOnlyList<(string Type, string Name)>? additionalProperties, string sourceFilePath)
        {
            this.Name = name;
            this.Namespace = ns;
