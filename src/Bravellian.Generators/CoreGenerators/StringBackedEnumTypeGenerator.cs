...
public readonly partial record struct {{relatedClass.Name}}
        : IComparable,
          ...
          Bravellian.IBgEnum<{{relatedClass.Name}}>
{
{{constValues}}
...
""";
    ...
    public readonly record struct GeneratorParams
    {
        ...
        public GeneratorParams(string name, string ns, bool isPublic, IReadOnlyList<(string Value, string Name, string? DisplayName, string? Documentation)>? enumValues, IReadOnlyList<(string Type, string Name)>? additionalProperties, string sourceFilePath)
        {
            this.Name = name;
            this.Namespace = ns;
