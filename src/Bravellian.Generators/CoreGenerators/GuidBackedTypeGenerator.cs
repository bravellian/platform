...
public static class GuidBackedTypeGenerator
{
    ...
    private static string GenerateClass(GeneratorParams relatedClass)
    {
        ...
        var bravellianInterfaces = GeneratorConfig.IncludeBravellianInterfaces
            ? new[] { "Bravellian.IHasValueConverter", $"Bravellian.IBgParsable<{relatedClass.Name}>", $"Bravellian.IGuidBackedType<{relatedClass.Name}>" }
            : Array.Empty<string>();
...
""";
    ...
    public readonly record struct GeneratorParams
    {
        ...
        public GeneratorParams(string name, string ns, bool isPublic, bool useDefaultFormat, string sourceFilePath)
        {
            this.Name = name;
            this.Namespace = ns;
