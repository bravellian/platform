...
public readonly partial record struct {{relatedClass.Name}}
        : IComparable,
          ...
          Bravellian.IBgParsable<{{relatedClass.Name}}>,
...
""";
    ...
    public readonly record struct GeneratorParams
    {
        ...
        public GeneratorParams(string name, string ns, bool isPublic, string separator, string format, string regex, string bookend, IReadOnlyList<FieldInfo> fields, string sourceFilePath)
        {
            this.Name = name;
            this.Namespace = ns;
