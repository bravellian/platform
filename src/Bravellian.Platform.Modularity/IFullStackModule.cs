...
/// <summary>
/// Module that includes UI assets in addition to APIs.
/// </summary>
public interface IFullStackModule : IApiModule
{
    /// <summary>
    ...
    /// <summary>
    /// Navigation links exposed by the module.
    /// </summary>
    /// <returns>The navigation links.</returns>
    IEnumerable<ModuleNavLink> GetNavLinks();
}
