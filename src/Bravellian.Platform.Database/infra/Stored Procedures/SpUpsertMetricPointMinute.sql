CREATE   PROCEDURE [infra].[SpUpsertMetricPointMinute]
  @SeriesId BIGINT,
...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM [infra].[MetricPointMinute] WITH (UPDLOCK, HOLDLOCK)
  ...
  BEGIN
    ...
    UPDATE [infra].[MetricPointMinute]
  ...
  ELSE
  BEGIN
    INSERT INTO [infra].[MetricPointMinute](SeriesId, BucketStartUtc, BucketSecs,
