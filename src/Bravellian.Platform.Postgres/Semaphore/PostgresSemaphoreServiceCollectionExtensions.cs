...
/// </summary>
internal static class PostgresSemaphoreServiceCollectionExtensions
{
    /// <summary>
    ...
    /// <param name="schemaName">The schema name for semaphore tables (default: "infra").</param>
    /// <param name="configure">Optional configuration action.</param>
    internal static void AddSemaphoreServices(
        this IServiceCollection services,
        string connectionString,
        string schemaName = "infra",
        Action<PostgresSemaphoreOptions>? configure = null)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(connectionString);
        ArgumentException.ThrowIfNullOrWhiteSpace(schemaName);

        services.AddOptions<PostgresSemaphoreOptions>()
            .Configure(options =>
            {
        ...
        services.AddSingleton<ISemaphoreService, PostgresSemaphoreService>();
