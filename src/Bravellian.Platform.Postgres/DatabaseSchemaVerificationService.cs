...
internal sealed class DatabaseSchemaVerificationService : BackgroundService
{
    ...
    [
        new ColumnSpec("CreatedOn", "timestamp with time zone", IsNullable: false),
        new ColumnSpec("ProcessedOn", "timestamp with time zone", IsNullable: true),
        new ColumnSpec("AttemptCount", "integer", IsNullable: false),
        new ColumnSpec("DueOn", "timestamp with time zone", IsNullable: true),
    ];
    ...
    [
        ...
        new ColumnSpec("AttemptCount", "integer", IsNullable: false),
        new ColumnSpec("DueOn", "timestamp with time zone", IsNullable: true),
        new ColumnSpec("CorrelationId", "text", IsNullable: true),
        new ColumnSpec("ProcessedBy", "text", IsNullable: true),
    ];
