...
public interface IInboxWorkStore
{
    ...
    Task<IReadOnlyList<InboxMessageIdentifier>> ClaimAsync(Bravellian.Platform.OwnerToken ownerToken, int leaseSeconds, int batchSize, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task AckAsync(Bravellian.Platform.OwnerToken ownerToken, IEnumerable<InboxMessageIdentifier> messageIds, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task AbandonAsync(Bravellian.Platform.OwnerToken ownerToken, IEnumerable<InboxMessageIdentifier> messageIds, string? lastError = null, TimeSpan? delay = null, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task FailAsync(Bravellian.Platform.OwnerToken ownerToken, IEnumerable<InboxMessageIdentifier> messageIds, string errorMessage, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task ReviveAsync(IEnumerable<InboxMessageIdentifier> messageIds, string? reason = null, TimeSpan? delay = null, CancellationToken cancellationToken = default);
    ...
    Task<InboxMessage> GetAsync(InboxMessageIdentifier messageId, CancellationToken cancellationToken);
}
